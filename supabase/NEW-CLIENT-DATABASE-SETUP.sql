-- ========================================
-- NEW CLIENT-SIDE DATABASE SETUP
-- ========================================
-- Yeh queries NAYE Supabase project mein run karo
-- Yeh client-side ke liye dedicated database hoga
...
-- ========================================
-- STEP 7: Insert Default Clinic Data
-- ========================================
...
SELECT 'Default clinic inserted!' as status;
...
SELECT 'Sample FAQs inserted!' as status;
...
-- Show clinic data
SELECT 'Clinic Data:' as info;
SELECT id, name, phone, active FROM clinics;

-- Show FAQs
SELECT 'FAQs Data:' as info;
SELECT question, category FROM faqs;

SELECT '✅ Database is ready for client-side use!' as final_message;
