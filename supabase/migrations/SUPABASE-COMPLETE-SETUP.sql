...
-- Clínica San Miguel - SanMiguel Connect AI
-- ============================================
-- Ye SQL file Supabase SQL Editor mein run karo
-- ============================================
...
INSERT INTO faqs (question, answer, category, language, keywords, active) VALUES
  ...
  ('What services do you offer?', 'We offer general consultations, pediatrics, vaccinations, lab tests, and X-rays.', 'Services', 'en', ARRAY['services', 'treatment'], true),
  ('¿Qué servicios ofrecen?', 'Ofrecemos consultas generales, pediatría, vacunas, análisis de laboratorio y rayos X.', 'Services', 'es', ARRAY['servicios'], true)
ON CONFLICT DO NOTHING;
...
-- SETUP COMPLETE! ✅
-- ============================================
-- Ab apna application start karo: npm run dev
-- ============================================
